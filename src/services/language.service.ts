...
const translations = {
  ...
  'download_windows': { en: 'Download for Windows', zh: '下载 Windows 版' },
  'download_android': { en: 'Download for Android', zh: '下载 Android 版' },
  'download_ios': { en: 'Download for iOS', zh: '下载 iOS 版' },
